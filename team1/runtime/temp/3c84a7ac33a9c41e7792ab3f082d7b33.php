...
<script type="text/javascript">
   ...
   <!-- 名字 -->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-name" data-rule="required" class="form-control" name="row[nickname]" type="text" value="<?php echo htmlentities($row['nickname']); ?>">
        </div>
    </div>
    <!-- 封面 -->
       <div class="form-group">
 ...
 <!-- 资料描述 -->
     <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea name="row[description]" id="c-editor" cols="60" rows="20" class="form-control editor"><?php echo $row['description']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
