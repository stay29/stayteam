 ...
 <!-- 名字 -->
    ...
    <!-- 下载 -->
     <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" name="row[diyname]" id="c-local" class="form-control"   value="<?php echo htmlentities($row['diyname']); ?>" readonly="readonly"/>
        </div>
    </div>
    <div class="form-group">
  ...
  <!-- 描述 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-description" class="form-control" name="row[description]" rows="10" cols="10"><?php echo htmlentities($row['description']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
